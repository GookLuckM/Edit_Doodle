    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doodleView = new DoodleView(this, bitmap, new IDoodleListener() {
            ...
            public void onReady(IDoodle doodle) {
                doodle.setSize(40 * doodle.getUnitSize(),-1);
                IDoodleSelectableItem item = new DoodleText(doodle, "Hello, world", doodle.getSize(), doodle.getColor(), 10, doodleView.getBitmap().getHeight()/2,false);
                ...
                DialogController.showInputTextDialog(ScaleGestureItemDemo.this, null,
                        new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                IDoodleSelectableItem item = new DoodleText(doodle, text, doodle.getSize(), doodle.getColor().copy(), x, y,false);
                                doodle.addItem(item);
                                touchGestureListener.setSelectedItem(item);
                                doodle.refresh();
                            }
