...
public final class PictureSelectionConfig implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(this.showOriginal ? (byte) 1 : (byte) 0);
        dest.writeByte(this.isMergeImage ? (byte) 1 : (byte) 0);
        dest.writeTypedList(this.selectionMedias);
        dest.writeString(this.topicName);
        dest.writeString(this.topTag);
    }
