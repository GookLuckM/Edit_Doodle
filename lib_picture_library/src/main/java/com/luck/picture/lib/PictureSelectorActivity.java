...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    public static final int MAX_VIDEO_TIME = 5 * 60 * 1000 + 500;   //最大选择五分钟的视频

    private final static String TAG = PictureSelectorActivity.class.getSimpleName();
    private static final int SHOW_DIALOG = 0;
    private static final int DISMISS_DIALOG = 1;
    private ImageView picture_left_back;
    private TextView picture_title, picture_right, picture_tv_ok, tv_empty, picture_id_preview, tv_PlayPause, tv_Stop, tv_Quit,
            tv_musicStatus, tv_musicTotal, tv_musicTime, original_image;
    ...
    private void initView(Bundle savedInstanceState) {
        ...
        if (config.isMergeImage){
            ...
            picture_right.setText(getResources().getString(R.string.picture_joint));
        }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.picture_left_back || id == R.id.picture_right) {
            ...
            if (id == R.id.picture_right && config.isMergeImage){
        ...
        switch (mediaType) {
            ...
            case PictureConfig.TYPE_IMAGE:
                ...
                if (config.selectionMode == PictureConfig.SINGLE && config.enableCrop) {
                    ...
                    adapter.getSelectedImages().add(media);
    ...
    public void changeImageNumber(List<LocalMedia> selectImages) {
        ...
        if (enable) {
            ...
            if (numComplete) {
                ...
                picture_tv_ok.setBackgroundResource(R.drawable.btn_fillet_orange);
                picture_tv_ok.setTextColor(0xffffffff);
            ...
            if (numComplete) {
                ...
                picture_tv_ok.setBackgroundResource(R.drawable.btn_fillet_orange_disable);
                picture_tv_ok.setTextColor(0x7fffffff);
                    ...
                    if (config.camera) {
                        ...
                        if (adapter != null) {
                            ...
                            if (selectedImages.size() < config.maxSelectNum) {
                                ...
                                boolean toEqual = PictureMimeType.isAddFile(pictureType, media.getPictureType(), mContext, config);
                                // 类型相同或还没有选中才加进选中集合中
    ...
    protected void onResume() {
        super.onResume();
        if(original_image != null && config != null){
