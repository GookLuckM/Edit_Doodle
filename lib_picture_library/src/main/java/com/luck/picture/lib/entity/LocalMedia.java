...
public class LocalMedia implements Parcelable {
    ...
    public LocalMedia(String path, long duration, int mimeType, String pictureType, int width, int height,long date) {
        this.path = path;
        this.duration = duration;
        this.mimeType = mimeType;
        this.pictureType = pictureType;
    ...
    public boolean equals(Object obj) {
        if(path != null && obj != null && obj instanceof LocalMedia){
